...
__name__ = 'datetime'
__package__ = None
class date(_mod___builtin__.object):
...
datetime_CAPI = _mod___builtin__.PyCapsule()
class time(_mod___builtin__.object):
...
class timedelta(_mod___builtin__.object):
...
class tzinfo(_mod___builtin__.object):
